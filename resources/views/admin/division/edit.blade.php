          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              @endif
                ...
                <div class="card-body">
       <form action="{{route('division.update',$edit_data->id)}}" method="post" class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="status" >
                        	<option value="1" {{($edit_data->status=="1")?"selected":""}}>Division Public</option>
                        	<option value="0" {{($edit_data->status=="0")?"selected":""}}>Division Private</option>
                        </select>
                      </div>
                       </div>
