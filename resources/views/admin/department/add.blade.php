          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              @endif
                ...
                <div class="card-body">
       <form action="{{route('department.store')}}" method="post" class="forms-sample"  enctype="multipart/form-data">
                    @csrf
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="status" required="">
                        	<option value="1">department Public</option>
                        	<option value="0">department Private</option>
                        </select>
                      </div>
                       </div>
